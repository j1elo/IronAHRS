...
void Read_Accel()
{
	...
	// No multiply by -1 for coordinate system transformation here, because of double negation:
	// we want the gravity vector, which is negated acceleration vector.
	accel[0] = 1.0 * axis[1]; // X axis (internal sensor -Y axis).
	accel[1] = 1.0 * axis[0]; // Y axis (internal sensor -X axis).
	accel[2] = 1.0 * axis[2]; // Z axis (internal sensor -Z axis).
}
...
void Read_Magn()
{
	...
	// Map X,Y,Z axis between physical board and logical algorithm.
	magnetom[0] = 1.0 * axis[1];  // X axis (internal sensor Y axis).
	magnetom[1] = 1.0 * axis[0];  // Y axis (internal sensor X axis).
	magnetom[2] = -1.0 * axis[2]; // Z axis (internal sensor -Z axis).
}
...
void Read_Gyro()
{
	...
	// Map X,Y,Z axis between physical board and logical algorithm.
	gyro[0] = -1.0 * axis[0]; // X axis (internal sensor -X axis).
	gyro[1] = -1.0 * axis[1]; // Y axis (internal sensor -Y axis).
	gyro[2] = 1.0 * axis[2]; // Z axis (internal sensor Z axis).
}
